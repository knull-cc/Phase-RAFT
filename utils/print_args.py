def print_args(args):
    ...
    print(f'  {"Phase Block:":<20}{args.phase_block:<20}{"PB Value:":<20}{args.phase_block_value_mode:<20}')
    print(f'  {"PB As Model:":<20}{args.phase_block_as_model:<20}{"PB Bank:":<20}{args.phase_block_bank_mode:<20}')
