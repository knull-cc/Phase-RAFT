...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Phase-aligned IdeaBlock Retrieval')
    ...
    parser.add_argument('--lradj', type=str, default='type1', help='adjust learning rate: type1, type2, cosine, none')
